"""
Django settings for sdfsdfsdf_2 project.
...
WSGI_APPLICATION = 'sdfsdfsdf_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "sdfsdfsdf_2 API",
    "DESCRIPTION": "API documentation for sdfsdfsdf_2 App",
    "VERSION": "v1",
}
